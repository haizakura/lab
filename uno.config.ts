...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'header-title': 'cursor-pointer text-decoration-none leading-[60px] font-bold text-black text-xl',
    ...
    'card-header': 'flex justify-between items-center cursor-pointer',
